  ...
  return (
    <div className='maindiv  backgroundimage' >
      <div className="svg relative">
        {
          useWindowWidth() >= 640 ? <> <svg xmlns="http://www.w3.org/2000/svg" width="274" height="568" fill="none" viewBox="0 0 274 568">
            <rect width="274" height="568" fill="#483EFF" rx="10" /><mask id="a" width="274" height="568" x="0" y="0"
              maskUnits="userSpaceOnUse" style={{ maskType: 'alpha' }}><rect width="274" height="568" fill="#fff" rx="10" />
            </mask><g mask="url(#a)"><path fill="#6259FF" fill-rule="evenodd" d="M-34.692 543.101C3.247 632.538 168.767 685.017 211.96 612.52c43.194-72.497-66.099-85.653-104.735-160.569-38.635-74.916-68.657-121.674-124.482-104.607-55.824 17.068-55.375 106.32-17.436 195.757Z" clip-rule="evenodd" />
            ...
            : <>
              <svg xmlns="http://www.w3.org/2000/svg" height="vh" viewBox="0 0 375 172">
                <defs>
                  ...
                  <g mask="url(#b)">
                    <g transform="translate(-151.029 -133.957)">
                      ...
                      <g stroke="#FFF" strokeLinecap="round" strokeLinejoin="bevel" strokeWidth="5">
                        ...
                        <path d="m430.872 251.016-17.995-15.112" />
                        <path d="m399.36 271.751-9.94 21.293" />
                      </g>
                    </g>
                  </g>
                </g>
              </svg>
              <div className="mobile absolute space-x-4 top-5 left-56 flex ">
                <span className='border h-8 w-8 rounded-full flex justify-center items-center hover:bg-Light-blue hover:text-black text-white font-semibold'>1</span>
                <span className='border h-8 w-8 rounded-full flex justify-center items-center hover:bg-Light-blue hover:text-black text-white font-semibold'>2</span>
                <span className='border h-8 w-8 rounded-full flex justify-center items-center hover:bg-Light-blue hover:text-black text-white font-semibold'>3</span>
                <span className='border h-8 w-8 rounded-full flex justify-center items-center hover:bg-Light-blue hover:text-black text-white font-semibold'>4</span>
              </div>
            </>
        }
      </div>
